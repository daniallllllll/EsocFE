...
DROP POLICY IF EXISTS "Security personnel can view events" ON public.security_events;
...
DROP POLICY IF EXISTS "Security personnel can insert events" ON public.security_events;
...
DROP POLICY IF EXISTS "Security personnel can update events" ON public.security_events;
